      ...
      >
        ...
        <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            <label htmlFor="signup-name" style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--text)' }}>
              Name
            </label>
            <input
              id="signup-name"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            <label htmlFor="signup-email" style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--text)' }}>
              Email
            </label>
            <input
              id="signup-email"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            <label htmlFor="signup-password" style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--text)' }}>
              Password
            </label>
            <input
              id="signup-password"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            <label htmlFor="signup-confirm" style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--text)' }}>
              Confirm Password
            </label>
            <input
              id="signup-confirm"
